...
~> DEVELOPER › @XB0BB -moataz
]])
if io.open("library/redis.lua","r") then
io.close(io.open("library/redis.lua","r"))
print("done => redis.lua")
else
io.popen("cd library && wget https://raw.githubusercontent.com/moatazkhaledd/XBB/master/library/redis.lua") 
...
local UserName = (data.username_ or "FKSource")
...
send(msg.chat_id_, msg.id_,' *٭ اصدار سورس FK* \n*٭ الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✬' and DevBoykAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ٭ [تحديثات البوت](t.me/FKSource) \n٭ [قناه السورس](t.me/FKSource)')
end
...
usertext = '*\n ٭ اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'FKSource')..')'
status  = '\n *٭ تم ترقيته مطور*'
...
usertext = '\n *٭ اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'FKSource')..')'
status  = '\n*٭ تم ترقيته مطور*'
...
if BoykA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *٭ اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'FKSource')..') \n ٭ '..BoykA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *٭ العضو :* {["..data.first_name_.."](T.ME/FKSource)}\n٭ ["..BoykA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *٭ عذرا ↫* {["..data.first_name_.."](T.ME/FKSource)}\n*٭ عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_, '*٭ بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'FKSource')..') \n*٭ تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *٭ بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'FKSource')..') \n*٭ تـم قفـل التاك بالكتم* ')
end,nil)   
...
if Get_info then
local TextS = "\n *٭ اهلا بك في متجر ملفات FK*\n*٭ ملفات السورس ↓*\n*•━━━━━━ 𝙵𝙺 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝙵𝙺 ━━━━━━━•*\n *٭ علامة تعني { ✓ } ملف مفعل*\n *٭ علامة تعني { ✘ } ملف معطل*\n *٭ قناة سورس FK↓*\n".." *٭ *[اضغط هنا لدخول](t.me/FKSource) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," *٭ عذرا الملف لايدعم سورس FK* \n") 
end
return false
end
...
local UserName = (b.username_ or "FKSource")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *٭ العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'FKSource')..')'
status  = '\n*٭ تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *٭ لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'FKSource')..')'
status  = '\n*٭ تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *٭ اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *٭ العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'FKSource')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *٭ اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'FKSource')..')'..'\n*٭ تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'FK').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'FK')
local BoykA_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
keyboard.inline_keyboard = {
{
{text = ' 𝗗𝗘𝗩 .', url = "https://t.me/FKILA"}
},
{
{text = ' 𝙎𝙊𝙐𝙍𝘾𝙀 .', url = "https://t.me/FKSource"}
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'FK').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'FKSource')..')'
local iduser = result.sender_user_id_
...
{{text = '- 𝚂𝙾𝚄𝚁𝙲𝙴 𝙵𝙺⁦', url="t.me/FKSource"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
send(msg.chat_id_, msg.id_, t..'ٴ✬∫ٴ*•━━━━━━ 𝙵𝙺 ━━━━━━━•*ٴ✬∫○ٴ\n٭ [- 𝚂𝙾𝚄𝚁𝙲𝙴 𝙵𝙺⁦](t.me/FKSource) ')
end
...
inline = {
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙵𝙺⁦',url='http://t.me/FKSource'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'FK')
...
------------------------------------------------------------------------
local revorb0t = database:get(bot_id.."BoykA1:Add:Filter:Rp2"..text..result.chat_id_)   
if revorb0t then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *٭ العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n٭ ["..revorb0t.."] \n") 
